...
const TOOL_TEXTS: Record<Locale, { tools: Record<string, ToolText>; common: CommonText }> = {
  en: {
    tools: {
      ...
      base64encoder: { title: "Base64 Encoder", description: "Encode/Decode Base64", seo: "Base64 string convert." },
      colorconverter: { title: "Color Converter", description: "HEX to RGB/HSL", seo: "Color code converter picker." },
  ...
  ko: {
    tools: {
      imagecompressor: { title: "이미지 압축기", description: "이미지 용량 줄이기", seo: "Webp로 변환하고 이미지 압축." },
      caseconverter: { title: "대소문자 변환기", description: "텍스트 대소문자 변환", seo: "로어케이스 및 어퍼케이스." },
      jsonformatter: { title: "JSON 포맷터", description: "JSON 정렬 및 검증", seo: "JSON 유효성 확인." },
      passwordgenerator: { title: "비밀번호 생성기", description: "안전한 비밀번호 만들기", seo: "랜덤 암호 생성기." },
      textdiffchecker: { title: "텍스트 비교기", description: "두 텍스트 차이점 찾기", seo: "텍스트 비교." },
      base64encoder: { title: "Base64 인코더", description: "Base64 변환기", seo: "문자열 인코딩 및 디코딩." },
      colorconverter: { title: "색상 변환기", description: "HEX RGB HSL 변환", seo: "컬러 코드 피커." },
