...
export const toolRenderers: Record<string, ToolRenderer> = {
  ...
  signboard: dynamic(() => import("@/features/tools/implementations/signboard").then(m => m.SignboardTool)),
  ...
  backgroundRemover: dynamic(() => import("@/features/tools/implementations/background-remover").then(m => m.BackgroundRemoverTool)),
  caseConverter: dynamic(() => import("@/features/tools/implementations/case-converter").then(m => m.CaseConverterTool)),
  pixelConverter: dynamic(() => import("@/features/tools/implementations/pixel-converter").then(m => m.PixelConverterTool)),
