...
export const CATEGORY_GROUPS: readonly CategoryGroupDefinition[] = [
  ...
  },
  {
    ...
    description: {
      en: "Tools for compressing, converting, resizing, and preparing image files.",
      ko: "이미지를 압축, 변환, 크기 조정, 정리하는 도구들입니다.",
      fr: "Outils pour compresser, convertir, redimensionner et préparer des images.",
      ja: "画像を圧縮・変換・サイズ調整するためのツールです。",
      zh: "用于压缩、转换、调整和准备图片文件的工具。",
      "zh-TW": "用於壓縮、轉換、調整與準備圖片檔案的工具。",
      pt: "Ferramentas para comprimir, converter, redimensionar e preparar imagens.",
      es: "Herramientas para comprimir, convertir, redimensionar y preparar imágenes.",
      de: "Werkzeuge zum Komprimieren, Umwandeln, Skalieren und Vorbereiten von Bilddateien.",
      ar: "أدوات لضغط الصور وتحويلها وتغيير حجمها وتجهيزها.",
    },
  },
  {
    id: "code-data-tools",
